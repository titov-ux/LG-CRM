...
export const vacanciesDb: Vacancy[] = assignKanbanOrders([
  ...
  { id: 'v4', title: 'Lead Data Engineer', clientId: 'c2', grade: 'Lead', stack: ['Python', 'Spark', 'Airflow'], format: 'Гибрид', rateClient: 5500, rateMax: 4000, positions: 1, status: 'new', priority: 'medium', recruiterIds: ['u6'], daysInStatus: 2, candidatesCount: 0, deadline: '2026-08-01' },
